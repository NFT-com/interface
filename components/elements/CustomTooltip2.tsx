...
function Tooltip(props : PropsWithChildren<ToolTipProps>) {
  ...
  return (
    <div className="relative flex items-center w-full" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} onClick={() => props.tooltipClick ? props.tooltipClick() : null}>
