      ...
      {({ index }) => (
        <>
          ...
          <div className='flex items-center justify-start py-5 flex-col homeTicker'>
            <div className='text-always-white text-section leading-2 tracking-wider font-header px-9 min-w-[250px] max-w-[250px] ...'>
              {props.tickerStats[`tickerStat${index+1}`].value}
            </div>
            <div className='text-[#B6B6B6] text-body leading-2 tracking-wider whitespace-normal font-header px-9 min-w-[250px] max-w-[250px] ...'>
