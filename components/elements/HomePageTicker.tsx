      ...
      {({ index }) => (
        <>
          ...
          <div className='flex items-center py-5 flex-col homeTicker'>
            <div className='text-always-white text-section leading-2 tracking-wider font-header px-12 w-full ...'>
              {props.tickerStats[`tickerStat${index+1}`].value}
            </div>
            <div className='text-[#B6B6B6] text-body leading-2 tracking-wider font-header px-12 w-full ...'>
