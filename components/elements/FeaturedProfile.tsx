...
export const FeaturedProfile = (props: FeaturedProfileProps) => {
  ...
  return (
    <div className='w-full h-full text-body text-[#6F6F6F] font-grotesk leading-body font-header drop-shadow-2xl md:py-4 py-12'>
      ...
      <div className='flex flex-col bg-[#B0AFAF26]/20 rounded-md backdrop-blur-xl px-4 py-6 max-w-[478px]'>
        ...
        <div className='grid grid-cols-1.3 grid-rows-[50%_50%] gap-x-2 gap-y-2 sm:gap-4 sm:grid-flow-col sm:auto-cols-[90%] sm:overflow-x-auto sm:grid-cols-none sm:grid-rows-1 md:min-h-[250px] sm:min-h-[410px] max-h-[400px] sm:max-h-max sm:overscroll-x-contain'>
