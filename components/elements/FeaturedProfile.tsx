  ...
  return (
    <div className='sm:w-full sm:h-full w-3/4 h-1/3 text-body text-secondary-txt-light leading-body font-header py-6'>
      ...
      <div className='flex flex-col bg-[#B0AFAF26]/20 rounded-md backdrop-blur-xl px-4 py-6'>
        ...
        <div className='grid grid-cols-1.3 grid-rows-2 gap-x-2 gap-y-2 sm:gap-4 sm:grid-flow-col sm:auto-cols-[90%] sm:overflow-x-auto sm:grid-cols-none sm:grid-rows-1 sm:min-h-[410px] overscroll-x-contain'>
