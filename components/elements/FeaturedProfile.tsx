        ...
        <div className={tw(
          ...
          <Link href={`/app/nft/${props.featuredNfts[0]?.contract}/${props.featuredNfts[0]?.tokenId}`} passHref>
            <a className='flex flex-col w-full minmd:row-span-2 row-auto minmd:aspect-auto aspect-square minmd:h-auto h-full'>
              <RoundedCornerMedia src={processIPFSURL(props.featuredNfts[0]?.previewLink || props.featuredNfts[0]?.metadata?.imageURL)} variant={RoundedCornerVariant.None} extraClasses='relative rounded-t-md object-cover' containerClasses='h-full w-full' />
          ...
          <div className='h-full w-full row-span-1 col-span-1'>
            <Link href={`/app/nft/${props.featuredNfts[1]?.contract}/${props.featuredNfts[1]?.tokenId}`} passHref>
              <a className='flex flex-col w-full row-auto minmd:aspect-auto aspect-square h-full justify-start'>
                <RoundedCornerMedia src={processIPFSURL(props.featuredNfts[1]?.previewLink ||props.featuredNfts[1]?.metadata?.imageURL)} variant={RoundedCornerVariant.None} extraClasses='relative rounded-t-md object-cover' containerClasses='h-full max-h-[77%] sm:max-h-full sm:w-full' />
          ...
          <div className='h-full w-full row-span-1 col-span-1'>
            <Link href={`/app/nft/${props.featuredNfts[2]?.contract}/${props.featuredNfts[2]?.tokenId}`} passHref>
              <a className='flex flex-col w-full row-auto minmd:aspect-auto aspect-square h-full justify-end'>
                <RoundedCornerMedia src={processIPFSURL(props.featuredNfts[2]?.previewLink || props.featuredNfts[2]?.metadata?.imageURL)} variant={RoundedCornerVariant.None} extraClasses='relative rounded-t-md object-cover' containerClasses='h-full max-h-[77%] sm:max-h-full sm:w-full' />
