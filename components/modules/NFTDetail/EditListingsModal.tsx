...
export function EditListingsModal(props: EditListingsModalProps) {
  ...
  }, [nft, collectionName, listings, stageListing, props.nft, props.collectionName, openseaAllowed, looksRareAllowed, X2Y2Allowed, X2Y2Allowed1155, NFTCOMAllowed, router]);
