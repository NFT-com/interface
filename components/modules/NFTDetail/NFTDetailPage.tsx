...
export function NFTDetailPage(props: NFTDetailPageProps) {
  ...
  return (
    <div className="flex flex-col pt-20 items-center w-full">
      ...
      <NFTDetailMoreFromCollection hideTokenId={nft?.tokenId} collectionName={nft?.contract == '0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85' ? 'ENS' || collection?.contractMetadata?.name} contract={nft?.contract} />
