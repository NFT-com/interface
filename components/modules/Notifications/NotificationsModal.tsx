  ...
  return (
    ...
    >
      <div className='max-w-full minlg:max-w-[458px] h-screen minlg:h-max maxlg:h-max bg-white text-left px-4 rounded-none minlg:rounded-[10px] minlg:mt-24 minlg:m-auto'>
        <div className='py-4 font-noi-grotesk lg:max-w-md max-w-lg m-auto minlg:relative'>
          <X onClick={() => setVisible(false)} className='absolute top-4 right-3 minlg:right-0 hover:cursor-pointer' size={32} color="black" weight="fill" />
