...
export function ProfileCard(props: ProfileCardProps) {
  ...
  if(isLeaderBoard){
    return (
      <a className="px-6 flex justify-between font-noi-grotesk  w-full flex justify-start items-center hover:scale-[1.01] transition-all cursor-pointer rounded-[16px] h-[6.25rem] shadow-lg overflow-hidden">
