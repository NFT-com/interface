    ...
    <table className="min-w-full border-x-0">
      <thead>
        <tr className="text-body leading-body font-body text-[#7F7F7F]">
          ...
          <th scope="col" className='text-right pr-3 minmd:text-body sm:text-sm leading-body font-body'>Number of NFT Collections</th>
          <th scope="col" className='text-right minmd:text-body sm:text-sm leading-body font-body'>Number of Genesis Keys</th>
        </tr>
      </thead>
