...
export interface NftGenesisStakeInterface extends utils.Interface {
  functions: {
...
export interface NftGenesisStake extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NftGenesisStakeInterface;
