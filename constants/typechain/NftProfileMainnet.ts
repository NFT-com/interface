...
export interface NftProfileMainnetInterface extends utils.Interface {
  functions: {
...
export interface NftProfileMainnet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NftProfileMainnetInterface;
