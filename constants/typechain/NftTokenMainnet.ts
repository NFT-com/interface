...
export interface NftTokenMainnetInterface extends utils.Interface {
  functions: {
...
export interface NftTokenMainnet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NftTokenMainnetInterface;
