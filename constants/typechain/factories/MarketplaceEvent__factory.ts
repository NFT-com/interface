...
export class MarketplaceEvent__factory {
  static readonly abi = _abi;
  static createInterface(): MarketplaceEventInterface {
    return new utils.Interface(_abi) as MarketplaceEventInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarketplaceEvent {
    return new Contract(address, _abi, signerOrProvider) as MarketplaceEvent;
  }
}
