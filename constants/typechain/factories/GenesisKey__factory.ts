...
import type { GenesisKey, GenesisKeyInterface } from "../GenesisKey";
...
export class GenesisKey__factory {
  static readonly abi = _abi;
  static createInterface(): GenesisKeyInterface {
    return new utils.Interface(_abi) as GenesisKeyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GenesisKey {
    return new Contract(address, _abi, signerOrProvider) as GenesisKey;
  }
}
