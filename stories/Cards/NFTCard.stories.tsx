...
export const DescriptionHidden = Template.bind({});
DescriptionHidden.args = {
...
export const EditModeVisible = Template.bind({});
EditModeVisible.args = {
  visible: true
};

export const EditModeHidden = Template.bind({});
EditModeHidden.args = {
  visible: false
};