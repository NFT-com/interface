...
export function getEnv(name: Doppler): any {
  switch(name) {
    ...
    case Doppler.NEXT_PUBLIC_DEV_CONTENT_MODEL_ENABLED: return true;
    ...
    case Doppler.NEXT_PUBLIC_DISCOVER2_PHASE3_ENABLED: return true;
    case Doppler.NEXT_PUBLIC_DISCOVER2_PHASE4_ENABLED: return true;
    ...
    case Doppler.NEXT_PUBLIC_TYPESENSE_SETUP_ENABLED: return true;
