...
export enum Doppler {
  ...
  NEXT_PUBLIC_BLOG_RESKIN_ENABLED = 'NEXT_PUBLIC_BLOG_RESKIN_ENABLED',
...
export function getEnv(name: Doppler): any {
  ...
  case Doppler.NEXT_PUBLIC_BLOG_RESKIN_ENABLED: return process.env.NEXT_PUBLIC_BLOG_RESKIN_ENABLED;
