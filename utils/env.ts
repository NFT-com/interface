...
export enum Doppler {
  ...
  NEXT_PUBLIC_DISCOVER2_PHASE4_ENABLED = 'NEXT_PUBLIC_DISCOVER2_PHASE4_ENABLED',
  ...
  NEXT_PUBLIC_GCP_IMG_PROXY_ENABLED = 'NEXT_PUBLIC_GCP_IMG_PROXY_ENABLED',
...
export function getEnv(name: Doppler): any {
  ...
  case Doppler.NEXT_PUBLIC_DISCOVER2_PHASE4_ENABLED: return process.env.NEXT_PUBLIC_DISCOVER2_PHASE4_ENABLED;
  ...
  case Doppler.NEXT_PUBLIC_GCP_IMG_PROXY_ENABLED: return process.env.NEXT_PUBLIC_GCP_IMG_PROXY_ENABLED;
