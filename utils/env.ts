...
export enum Doppler {
  ...
  NEXT_PUBLIC_RESOLVER_SIDEBAR_ENABLED = 'NEXT_PUBLIC_RESOLVER_SIDEBAR_ENABLED',
  ...
  NEXT_PUBLIC_UBIQUITY_API_KEY = 'NEXT_PUBLIC_UBIQUITY_API_KEY',
}
...
export function getEnv(name: Doppler): any {
  ...
  case Doppler.NEXT_PUBLIC_RESOLVER_SIDEBAR_ENABLED: return process.env.NEXT_PUBLIC_RESOLVER_SIDEBAR_ENABLED;
  ...
  case Doppler.NEXT_PUBLIC_UBIQUITY_API_KEY: return process.env.NEXT_PUBLIC_UBIQUITY_API_KEY;
  }
}
