...
export enum Doppler {
  ...
  NEXT_PUBLIC_NFT_DETAILS_ENABLED = 'NEXT_PUBLIC_NFT_DETAILS_ENABLED',
...
export function getEnv(name: Doppler): any {
  ...
  case Doppler.NEXT_PUBLIC_NFT_DETAILS_ENABLED: return process.env.NEXT_PUBLIC_NFT_DETAILS_ENABLED;
