...
export enum Doppler {
  ...
  NEXT_PUBLIC_HOMEPAGE_V3_ENABLED = 'NEXT_PUBLIC_HOMEPAGE_V3_ENABLED',
...
export function getEnv(name: Doppler): any {
  ...
  case Doppler.NEXT_PUBLIC_HOMEPAGE_V3_ENABLED: return process.env.NEXT_PUBLIC_HOMEPAGE_V3_ENABLED;
