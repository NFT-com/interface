...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const { sitemapFields } = await fetch(`${ctx.req.headers.host}/api/sitemaps/collection/nft?teamKey=${teamAuthToken}&chainId=${chainId}&collection=${collection}&page=${page}`).then((res) => res.json());
