...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const { sitemapFields } = await fetch(`${siteUrl}/api/sitemaps/collection/nft?teamKey=${teamAuthToken}&chainId=${chainId}&collection=${collection}&page=${page}`).then((res) => res.json());
